  ...
  return (
    <>
      <div className="fixed top-2 left-2 right-2 sm:left-3 sm:right-3 z-50 flex justify-center">
        <div
          className="relative flex w-full max-w-4xl items-center justify-between rounded-full border border-white/60 backdrop-blur-md shadow-lg px-3 sm:px-4 py-2 transition-all duration-300"
          style={{
        ...
        >
          <div className="p-4 sm:p-6">
            ...
            <nav className="flex flex-col space-y-1">
              ...
              <Link
                href={getContactLink(pathname)}
                className={`rounded-xl px-4 py-3 text-base font-medium text-white no-underline transition-all duration-200 mt-2 text-center ${
                  open ? "animate-slide-down-fade" : ""
                }`}
                style={{
